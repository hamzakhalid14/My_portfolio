    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('formation') }}" aria-current="page"><i class="fas fa-graduation-cap"></i> <span class="nav-text">Formation</span></a>
                </li>
                <li class="nav-item">
...
<main class="container" role="main">
    <h1 class="animate__animated animate__fadeInDown">
        <span class="fr">Parcours de Formation</span>
        <span class="en" style="display: none;">Educational Background</span>
    </h1>
        ...
        @foreach($formations as $formation)
            <div class="col-lg-6 mb-4 animate__animated animate__fadeInUp">
                <div class="formation-card">
                    <h3>
                        <span class="fr">{{ $formation->title }}</span>
                        <span class="en" style="display: none;">{{ $formation->title_en }}</span>
                    </h3>
                    <p class="institution">
                    ...
                    <p>
                        <span class="fr">{{ $formation->description }}</span>
                        <span class="en" style="display: none;">{{ $formation->description_en }}</span>
                    </p>
                </div>
            </div>
        @endforeach
